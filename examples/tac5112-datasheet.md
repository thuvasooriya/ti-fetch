...
**Source:** [TI Document Viewer](https://www.ti.com/document-viewer/TAC5112/datasheet)

---

Data Sheet

# TAC5112 Low-power stereo audio codec with 105dB dynamic range ADC and 114dB dynamic range DAC


# 1  Features

-   Stereo low-power audio ADC
    -   Performance:
        -   Line/Microphone differential input dynamic range: 105dB
        -   THD+N: –97dB
        -   Channel summing mode supports high SNR: 108dB
    -   Input voltage:
...
-   Stereo differential or Quad single-ended high performance audio DAC
    -   Performance:
        ...
        -   DAC to differential headphone-out dynamic range: 114dB
        -   THD+N:–96dB
...
The TAC5112 is a low-power stereo audio codec with 2V<sub>RMS</sub> differential input, 105dB stereo ADC and 2V<sub>RMS</sub> differential output, 114dB stereo or 1V<sub>RMS</sub> single-ended output, 107dB quad DAC. The TAC5112 supports both differential and single-ended inputs and outputs. The ADC supports both line/microphone input signals with options for AC or DC coupling configurations. The DAC outputs can be configured for either line-output or headphone loads. The DAC can drive up to 62.5mW into a 16Ω headphone load. The TAC5112 integrates programable channel gain, digital volume control, a low-jitter phase-locked loop (PLL), a programmable high-pass filter (HPF), programmable EQ and biquad filters, low-latency and ultra-low latency filter modes, and allows for sample rates up to 768kHz for both ADC and DAC signal chains. The TAC5112 supports time-division multiplexing (TDM), I<sup>2</sup>S, or left-justified (LJ) audio formats, and can be controlled with I<sup>2</sup>C or SPI. These integrated high-performance features, along with a single supply operation, makes TAC5112 an excellent choice for space-constrained audio applications.
...
| --- | --- | --- |
| TAC5112 | VQFN (24) | 4mm x 4mm with 0.5mm pitch |
...
![TAC5112 Simplified Block Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-20231214-SS0I-3JP5-QBKN-KNQSWKTSTWLJ-low.svg) 
...
![TAC5112 24-Pin QFN Package with Exposed Thermal Pad and Corner Pins, Top View](https://www.ti.com/ods/images/SLASF24A/GUID-20241125-SS0I-1CWO-7COX-15H2Y91PZ309-low.svg) 
...
| 24 PINS | THERMAL METRIC <sup>(1)</sup> | TAC5112 | UNIT |
| --- | --- | --- | --- |
...
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain | INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain |  | 104 |  | dB |
| INxx differential AC-coupled input and AC signal shorted to ground, 12dB channel gain | INxx differential AC-coupled input and AC signal shorted to ground, 12dB channel gain |  | 102 |  |  |  | dB |
| INxx differential DC-coupled input and AC signal shorted to ground, 0dB channel gain | INxx differential DC-coupled input and AC signal shorted to ground, 0dB channel gain |  | 102 |  |  |  | dB |
...
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | Wideband Mode <sup>(4)</sup> : INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain (Integrated till 20kHz and A-Weighted) | Wideband Mode <sup>(4)</sup> : INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain (Integrated till 20kHz and A-Weighted) |  | 103 |  | dB |
| SNR | Signal-to-noise ratio <sup>(1)</sup> | Wideband Mode <sup>(4)</sup> : INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain (Integrated till 85kHz) | Wideband Mode <sup>(4)</sup> : INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain (Integrated till 85kHz) |  | 91 |  | dB |
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | Power Tune Mode <sup>(5)</sup> : INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain | Power Tune Mode <sup>(5)</sup> : INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain |  | 101 |  | dB |
| Power Tune Mode <sup>(5)</sup> : INxx differential DC-coupled input and AC signal shorted to ground, 0dB channel gain | Power Tune Mode <sup>(5)</sup> : INxx differential DC-coupled input and AC signal shorted to ground, 0dB channel gain |  | 101 |  |  |  | dB |
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain, AVDD = 1.8V | INxx differential AC-coupled input and AC signal shorted to ground, 0dB channel gain, AVDD = 1.8V |  | 103 |  | dB |
| INxx differential DC-coupled input and AC signal shorted to ground, 0dB channel gain, AVDD = 1.8V | INxx differential DC-coupled input and AC signal shorted to ground, 0dB channel gain, AVDD = 1.8V |  | 101 |  |  |  | dB |
...
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | INxx single-ended AC-coupled input and AC signal shorted to ground, 0dB channel gain | INxx single-ended AC-coupled input and AC signal shorted to ground, 0dB channel gain |  | 102 |  | dB |
| Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | INxx single-ended AC-coupled input and AC signal shorted to ground, 12dB channel gain | INxx single-ended AC-coupled input and AC signal shorted to ground, 12dB channel gain |  | 97 |  |  | dB |
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | INxx single-ended DC-coupled input and AC signal shorted to ground, 0dB channel gain | INxx single-ended DC-coupled input and AC signal shorted to ground, 0dB channel gain |  | 101 |  | dB |
...
| DR | Dynamic range, A-weighted <sup>(2)</sup> | INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain | INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain |  | 105 |  | dB |
| INxx differential DC-coupled input and –60dBFS AC signal input, 0dB channel gain | INxx differential DC-coupled input and –60dBFS AC signal input, 0dB channel gain |  | 104 |  |  |  | dB |
| INxx differential DC-coupled input and –72dBFS AC signal input, 12dB channel gain | INxx differential DC-coupled input and –72dBFS AC signal input, 12dB channel gain |  | 99 |  |  |  | dB |
| DR | Dynamic range, A-weighted <sup>(2)</sup> | Power Tune Mode <sup>(5)</sup> : INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain | Power Tune Mode <sup>(5)</sup> : INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain |  | 103 |  | dB |
| Power Tune Mode <sup>(5)</sup> : INxx differential DC-coupled input and –60dBFS AC signal input, 0dB channel gain | Power Tune Mode <sup>(5)</sup> : INxx differential DC-coupled input and –60dBFS AC signal input, 0dB channel gain |  | 102 |  |  |  | dB |
| DR | Dynamic range, A-weighted <sup>(2)</sup> | INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain, AVDD = 1.8V | INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain, AVDD = 1.8V |  | 104 |  | dB |
| INxx differential DC-coupled input and –60dBFS AC signal input, 0dB channel gain, AVDD = 1.8V | INxx differential DC-coupled input and –60dBFS AC signal input, 0dB channel gain, AVDD = 1.8V |  | 103 |  |  |  | dB |
...
| DR | Dynamic range, A-weighted <sup>(2)</sup> | Power Tune Mode: INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain, AVDD = 1.8V | Power Tune Mode: INxx differential AC-coupled input and –60dBFS AC signal input, 0dB channel gain, AVDD = 1.8V |  | 102 |  | dB |
| Power Tune Mode: INxx differential DC-coupled input and –60dBFS signal input, 0dB channel gain, AVDD = 1.8V | Power Tune Mode: INxx differential DC-coupled input and –60dBFS signal input, 0dB channel gain, AVDD = 1.8V |  | 101 |  |  |  | dB |
| DR | Dynamic range, A-weighted <sup>(2)</sup> | INxx single-ended AC-coupled input and –60dBFS AC signal input, 0dB channel gain | INxx single-ended AC-coupled input and –60dBFS AC signal input, 0dB channel gain |  | 104 |  | dB |
| DR | Dynamic range, A-weighted <sup>(2)</sup> | INxx single-ended DC-coupled input and –60dBFS AC signal input, 0dB channel gain | INxx single-ended DC-coupled input and –60dBFS AC signal input, 0dB channel gain |  | 102 |  | dB |
...
| DR | Dynamic range, A-weighted <sup>(2)</sup> | INxx single-ended mux AC-coupled input and –60dBFS AC signal input, 0dB channel gain, 10kΩ input impedance | INxx single-ended mux AC-coupled input and –60dBFS AC signal input, 0dB channel gain, 10kΩ input impedance |  | 97 |  | dB |
| THD+N | Total harmonic distortion <sup>(2)</sup> | INxx differential AC-coupled input and –1dBFS AC signal input, 0dB channel gain | INxx differential AC-coupled input and –1dBFS AC signal input, 0dB channel gain |  | –97 |  | dB |
| INxx differential DC-coupled input and –1dBFS AC signal input, 0dB channel gain | INxx differential DC-coupled input and –1dBFS AC signal input, 0dB channel gain |  | –97 |  |  |  | dB |
...
| THD+N | Total harmonic distortion <sup>(2)</sup> | INxx single-ended AC-coupled input and –1dBFS AC signal input, 0dB channel gain | INxx single-ended AC-coupled input and –1dBFS AC signal input, 0dB channel gain |  | –94 |  | dB |
| INxx single-ended DC-coupled input and –1dBFS AC signal input, 0dB channel gain | INxx single-ended DC-coupled input and –1dBFS AC signal input, 0dB channel gain |  | –85 |  |  |  | dB |
| INxx single-ended mux AC-coupled input and –1dBFS AC signal input, 0dB channel gain, 10kΩ input impedance | INxx single-ended mux AC-coupled input and –1dBFS AC signal input, 0dB channel gain, 10kΩ input impedance |  | –93 |  |  |  | dB |
...
| PSRR | Power-supply rejection ratio | 100mV<sub>PP</sub>, 1kHz sinusoidal signal on AVDD, differential input, 0dB channel gain | 100mV<sub>PP</sub>, 1kHz sinusoidal signal on AVDD, differential input, 0dB channel gain |  | 107 |  | dB |
| CMRR | Common-mode rejection ratio | Differential DC-coupled input, 0dB channel gain, –6dBFS AC input, 1kHz signal on both pins and measured level at output | Differential DC-coupled input, 0dB channel gain, –6dBFS AC input, 1kHz signal on both pins and measured level at output |  | 60 |  | dB |
...
|  | Noise, A-Weighted | Idle Channel, AC-Coupled Input Shorted to Ground, Differential output | Idle Channel, AC-Coupled Input Shorted to Ground, Differential output |  | 4.1 |  | µV<sub>RMS</sub> |
|  | Noise, A-Weighted | Idle Channel, AC-Coupled Input Shorted to Ground, Single-ended output | Idle Channel, AC-Coupled Input Shorted to Ground, Single-ended output |  | 21 |  | µV<sub>RMS</sub> |
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | Idle Channel, AC-Coupled Input Shorted to Ground, Differential output | Idle Channel, AC-Coupled Input Shorted to Ground, Differential output |  | 113 |  | dB |
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | Idle Channel, AC-Coupled Input Shorted to Ground, Single-ended output | Idle Channel, AC-Coupled Input Shorted to Ground, Single-ended output |  | 94 |  | dB |
...
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | Differential output, 0dBFS signal, AVDD=3.3V | Differential output, 0dBFS signal, AVDD=3.3V |  | 114 |  | dB |
| Single-ended output, 0dBFS signal, AVDD=3.3V | Single-ended output, 0dBFS signal, AVDD=3.3V |  | 107 |  |  |  | dB |
| Pseudo-differential output, 0dBFS signal, AVDD=3.3V | Pseudo-differential output, 0dBFS signal, AVDD=3.3V |  | 105 |  |  |  | dB |
| Differential output, 0dBFS signal, AVDD=1.8V | Differential output, 0dBFS signal, AVDD=1.8V |  | 109 |  |  |  | dB |
| Single-ended output, 0dBFS Signal, AVDD=1.8V | Single-ended output, 0dBFS Signal, AVDD=1.8V |  | 101 |  |  |  | dB |
| Pseudo-differential output, 0dBFS signal, AVDD=1.8V | Pseudo-differential output, 0dBFS signal, AVDD=1.8V |  | 99 |  |  |  | dB |
| Differential output, 0dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> | Differential output, 0dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> |  | 114 |  |  |  | dB |
| Single-ended output, 0dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> | Single-ended output, 0dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> |  | 103 |  |  |  | dB |
| Pseudo-differential output, 0dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> | Pseudo-differential output, 0dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> |  | 105 |  |  |  | dB |
| Differential output, 0dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> | Differential output, 0dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> |  | 108 |  |  |  | dB |
| Single-ended output, 0dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> | Single-ended output, 0dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> |  | 98 |  |  |  | dB |
| Pseudo-differential output, 0dBFS signal, AVDD=1.8V, Power Tune Mode | Pseudo-differential output, 0dBFS signal, AVDD=1.8V, Power Tune Mode |  | 99 |  |  |  | dB |
| SNR | Signal-to-noise ratio, A-weighted <sup>(1)</sup> <sup>(2)</sup> | Differential output, Receiver load, 0dBFS signal, AVDD=3.3V | Differential output, Receiver load, 0dBFS signal, AVDD=3.3V |  | 114 |  | dB |
| Single-ended output, Headphone load, 0dBFS signal, AVDD=3.3V | Single-ended output, Headphone load, 0dBFS signal, AVDD=3.3V |  | 107 |  |  |  | dB |
| Pseudo-differential output, Receiver load, 0dBFS signal, AVDD=3.3V | Pseudo-differential output, Receiver load, 0dBFS signal, AVDD=3.3V |  | 105 |  |  |  | dB |
| Differential output, Receiver load, 0dBFS signal, AVDD=1.8V | Differential output, Receiver load, 0dBFS signal, AVDD=1.8V |  | 109 |  |  |  | dB |
| Single-ended output, Headphone load, 0dBFS signal, AVDD=1.8V | Single-ended output, Headphone load, 0dBFS signal, AVDD=1.8V |  | 101 |  |  |  | dB |
| Pseudo-differential output, Receiver load, 0dBFS signal, AVDD=1.8V | Pseudo-differential output, Receiver load, 0dBFS signal, AVDD=1.8V |  | 99 |  |  |  | dB |
| DR | Dynamic range, A-weighted <sup>(2)</sup> | Differential output, -60dBFS signal, AVDD=3.3V | Differential output, -60dBFS signal, AVDD=3.3V |  | 114 |  | dB |
| Single-ended output, -60dBFS signal, AVDD=3.3V | Single-ended output, -60dBFS signal, AVDD=3.3V |  | 107 |  |  |  | dB |
| Pseudo-differential output, -60dBFS signal, AVDD=3.3V | Pseudo-differential output, -60dBFS signal, AVDD=3.3V |  | 106 |  |  |  | dB |
| Differential output, -60dBFS signal, AVDD=1.8V | Differential output, -60dBFS signal, AVDD=1.8V |  | 110 |  |  |  | dB |
| Single-ended output, -60dBFS Signal, AVDD=1.8V | Single-ended output, -60dBFS Signal, AVDD=1.8V |  | 101 |  |  |  | dB |
| Pseudo-differential output, -60dBFS signal, AVDD=1.8V | Pseudo-differential output, -60dBFS signal, AVDD=1.8V |  | 100 |  |  |  | dB |
| Differential output, -60dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> | Differential output, -60dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> |  | 114 |  |  |  | dB |
...
| Pseudo-differential output, -60dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> | Pseudo-differential output, -60dBFS signal, AVDD=3.3V, Power Tune Mode <sup>(5)</sup> |  | 105 |  |  |  | dB |
| Differential output, -60dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> | Differential output, -60dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> |  | 109 |  |  |  | dB |
| Single-ended output, -60dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> | Single-ended output, -60dBFS signal, AVDD=1.8V, Power Tune Mode <sup>(5)</sup> |  | 99 |  |  |  | dB |
| Pseudo-differential output, -60dBFS signal, AVDD=1.8V, Power Tune Mode | Pseudo-differential output, -60dBFS signal, AVDD=1.8V, Power Tune Mode |  | 99 |  |  |  | dB |
| DR | Dynamic range, A-weighted <sup>(2)</sup> | Differential-output, Receiver load, -60dBFS signal, AVDD=3.3V | Differential-output, Receiver load, -60dBFS signal, AVDD=3.3V |  | 114 |  | dB |
| Single-ended output, Headphone load, -60dBFS signal, AVDD=3.3V | Single-ended output, Headphone load, -60dBFS signal, AVDD=3.3V |  | 107 |  |  |  | dB |
| Pseudo-differential output, Receiver load, -60dBFS signal, AVDD=3.3V | Pseudo-differential output, Receiver load, -60dBFS signal, AVDD=3.3V |  | 106 |  |  |  | dB |
| Differential-output, Receiver load, -60dBFS signal, AVDD=1.8V | Differential-output, Receiver load, -60dBFS signal, AVDD=1.8V |  | 110 |  |  |  | dB |
| Single-ended output, Headphone load, -60dBFS signal, AVDD=1.8V | Single-ended output, Headphone load, -60dBFS signal, AVDD=1.8V |  | 102 |  |  |  | dB |
| Pseudo-differential output, Receiver load, -60dBFS signal, AVDD=1.8V | Pseudo-differential output, Receiver load, -60dBFS signal, AVDD=1.8V |  | 100 |  |  |  | dB |
| THD+N | Total harmonic distortion <sup>(2)</sup> | Differential output, –1dBFS signal, AVDD= 3.3V | Differential output, –1dBFS signal, AVDD= 3.3V |  | –96 |  | dB |
| Single-ended output, –1dBFS signal, AVDD= 3.3V | Single-ended output, –1dBFS signal, AVDD= 3.3V |  | –94 |  |  |  | dB |
| Psuedo-differential output, –1dBFS signal, AVDD= 3.3V | Psuedo-differential output, –1dBFS signal, AVDD= 3.3V |  | –93 |  |  |  | dB |
...
|  | Digital high-pass filter cutoff frequency | First-order IIR filter with programmable coefficients, –3dB point (default setting) | First-order IIR filter with programmable coefficients, –3dB point (default setting) |  | 1 |  | Hz |
|  | Interchannel isolation | Differential output, –1dBFS input signal on nonmeasurement channel | Differential output, –1dBFS input signal on nonmeasurement channel |  | –120 |  | dB |
...
| PSRR | Power-supply rejection ratio | 100-mV<sub>PP</sub>, 1kHz sinusoidal signal on AVDD, differential input selected, 0dB channel gain | 100-mV<sub>PP</sub>, 1kHz sinusoidal signal on AVDD, differential input selected, 0dB channel gain |  | 110 |  | dB |
...
| I<sub>IOVDD</sub> |  | 0.3 |  |  |  |  | mA |
| I<sub>AVDD</sub> | Current consumption with DAC to Headphone 2-channel operation, MICBIAS off, PLL on | f<sub>S</sub> = 16kHz, BCLK = 512 × f<sub>S</sub> | f<sub>S</sub> = 16kHz, BCLK = 512 × f<sub>S</sub> |  | 17.9 |  | mA |
| I<sub>IOVDD</sub> |  | 0.02 |  |  |  |  | mA |
| I<sub>AVDD</sub> | Current consumption with DAC to Headphone 2-channel operation, MICBIAS off, PLL off | f<sub>S</sub> = 48kHz, BCLK = 512 × f<sub>S</sub> | f<sub>S</sub> = 48kHz, BCLK = 512 × f<sub>S</sub> |  | 15.2 |  | mA |
| I<sub>IOVDD</sub> |  | 0.04 |  |  |  |  | mA |
| I<sub>AVDD</sub> | Current consumption with ADC 2-channel operation and DAC to Headphone 2-channel operation, MICBIAS on, PLL on | f<sub>S</sub> = 48kHz, BCLK = 512 × f<sub>S</sub> | f<sub>S</sub> = 48kHz, BCLK = 512 × f<sub>S</sub> |  | 27.6 |  | mA |
| I<sub>IOVDD</sub> |  | 0.3 |  |  |  |  | mA |
...
| I<sub>AVDD</sub> | Power Tune Mode <sup>(5)</sup> : Current consumption with DAC to Lineout 2-channel single-ended operation, MICBIAS off, PLL off, AVDD=1.8V | f<sub>S</sub> = 48kHz, BCLK = 128 × f<sub>S</sub> | f<sub>S</sub> = 48kHz, BCLK = 128 × f<sub>S</sub> |  | 5.5 |  | mA |
...
(5)  PWR_TUNE_CFG0 = 0xD4, PWR_TUNE_CFG1 = 0x86 and PLL_DIS = 1'b1 for Power Tune Mode
...
![TAC5112 I2C Interface Timing Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-20231009-SS0I-300N-XD8N-ZDDD7TTRNTZR-low.svg) 

**Figure 6-1 I<sup>2</sup>C Interface Timing Diagram**

![TAC5112 SPI Interface Timing Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-20231009-SS0I-6L8Q-MLMT-MCFKJHSC35WG-low.svg) 

**Figure 6-2 SPI Interface Timing Diagram**

![TAC5112 TDM (With BCLK_POL = 1), I2S, and LJ Interface Timing Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-20231009-SS0I-FCBW-DTMP-2ZFP5RXVFKRC-low.svg) 

**Figure 6-3 TDM (With BCLK_POL = 1), I<sup>2</sup>S, and LJ Interface Timing Diagram**

![TAC5112 PDM Digital Microphone Interface Timing Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-20231009-SS0I-3QDJ-N23S-374Z4CJLFZJL-low.svg) 
...
![TAC5112 ADC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-ULKM-2F4H-558R5XCZ7WGQ-low.svg)
...
![TAC5112 ADC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-V1QW-W2UG-9M59KABS54M7-low.svg)
...
![TAC5112 ADC A-weighted DR vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-7CRM-Z37N-EPWACR1ZT8KP-low.svg)
...
![TAC5112 ADC THD+N vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-XKH7-FDFV-D081DIKIACRH-low.svg)
...
![TAC5112 ADC Frequency Response](https://www.ti.com/ods/images/SLASF24A/GUID-20240930-SS0I-VIWO-3UE1-8XLX16QB08BT-low.svg)
...
![TAC5112 ADC FFT with –60dBFS Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-EDJ5-LNLA-UN48L2HD7173-low.svg)
...
![TAC5112 ADC CMRR vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-TIE5-IR88-92S4MD5R55N8-low.svg)
...
![TAC5112 DAC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-TFKU-8OTO-58NZN61P2OYR-low.svg)
...
![TAC5112 DAC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-ZA03-S4I1-OMJ0XMU80W72-low.svg)
...
![TAC5112 DAC THD+N Level vs output power](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-MFIK-X2R1-K1DGE0H7RX79-low.svg)
...
![TAC5112 DAC THD+N Level vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-S8D6-IQIU-GXDTNQWLMMNZ-low.svg)
...
![TAC5112 DAC THD+N Level vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-ZSHK-IXKS-TLA84F09E7R2-low.svg)
...
![TAC5112 DAC FFT with Idle Channel Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-4AZQ-KDZX-8GE181USXM3P-low.svg)
...
![TAC5112 DAC FFT with -1dBFS Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-XVC0-2AFH-RV65GLW581T0-low.svg)
...
![TAC5112 DAC PSRR vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-8X8Y-I21L-YFU6UNQIUNSM-low.svg)
...
![TAC5112 ADC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-WK1Z-QHHH-C2BQ894YOHGR-low.svg)
...
![TAC5112 ADC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-O5F2-BX4T-3FHO192BTQ7W-low.svg)
...
![TAC5112 ADC A-weighted DR vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-HQY3-FH9F-3LR4LGW3RVG0-low.svg)
...
![TAC5112 ADC THD+N vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-SU8W-RSOO-EGNM92I3IYEL-low.svg)
...
![TAC5112 ADC FFT With Idle Channel Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-Q6ZS-RRY3-YCZBAQE2P9WL-low.svg)
...
![TAC5112 ADC FFT with -1dBFS Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-EUQD-33VQ-TWTJ03UNAYIP-low.svg)
...
![TAC5112 ADC PSRR vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-FQ5B-K77L-ZKWD7Q2K6D1C-low.svg)
...
![TAC5112 DAC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-I9QU-FP88-X9GJW5B9BO80-low.svg)
...
![TAC5112 DAC THD+N Level vs output power](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-BM9B-LYCA-98JHW2TVA0I4-low.svg)
...
![TAC5112 DAC THD+N Level vs output power](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-9UM1-ZJW6-3MD9629GSTC9-low.svg)
...
![TAC5112 DAC THD+N Level vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-FTVE-XIFD-IK5CSJB5Y35B-low.svg)
...
![TAC5112 DAC THD+N Level vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-CNSE-0C2V-0NL5LJRB8XNP-low.svg)
...
![TAC5112 DAC FFT with -60dBFS Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-3TQO-KF1N-971DNRZ7C8WX-low.svg)
...
![TAC5112 DAC PSRR vs Frequency](https://www.ti.com/ods/images/SLASF24A/GUID-20241007-SS0I-G8FZ-KDF2-H4PVZQ449I4V-low.svg)
...
![TAC5112 DAC Frequency Response](https://www.ti.com/ods/images/SLASF24A/GUID-20241004-SS0I-BFGQ-V5WZ-48LY59I1JQUX-low.svg)
...
Communication to the TAC5112 for configuring the control registers is supported using an I<sup>2</sup>C or SPI interface. The device supports a highly flexible audio serial interface \[time-division multiplexing (TDM), I<sup>2</sup>S, or left-justified (LJ)\] to transmit audio data seamlessly in the system across devices.
...
![TAC5112 Functional Block Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-20221226-SS0I-RWJR-51B5-NBR4RJDXN1T4-low.svg) 
...
Digital audio data flows between the host processor and the TAC5112 on the digital audio serial interface (ASI), or audio bus. This highly flexible ASI bus includes a TDM mode for multichannel operation, support for I<sup>2</sup>S or left-justified protocols format, programmable data length options, very flexible controller-target configurability for bus clock lines, and the ability to communicate with multiple devices within a system directly.

The TAC5112 supports up to two ASI Interfaces. Secondary ASI Clock and Data Pins can be configured by setting GPIO's. Frame Sync of two ASI's must be synchronous. See the [_TAX5X1X Synchronous Sample Rate Conversion_ application report](https://www.ti.com/lit/pdf/SLAAEH2) for more details on Secondary ASI.
...
The slot word length is the same as the primary ASI channel word length set for the device. The output channel data word length must be set to the same value for all TAC5112 devices if all devices share the same ASI bus in a system. The maximum number of slots possible for the ASI bus in a system is limited by the available bus bandwidth, which depends upon the BCLK frequency, output data sample rate used, and the channel data word length configured.
...
![TAC5112 TDM Mode Standard Protocol Timing (PASI_TX_OFFSET = 0)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-8216-G6PG-IPAEGDXY18YE-low.svg) 

**Figure 7-2 TDM Mode Standard Protocol Timing (PASI_TX_OFFSET = 0)**

![TAC5112 TDM Mode Protocol Timing (PASI_TX_OFFSET = 2)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-SQQW-Y6CH-5O9K8YW2VEXI-low.svg) 

**Figure 7-3 TDM Mode Protocol Timing (PASI_TX_OFFSET = 2)**

![TAC5112 TDM Mode Protocol Timing (No Idle BCLK Cycles, PASI_TX_OFFSET = 2)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-VJ3O-BQO5-926RW2Y6QKYR-low.svg) 

**Figure 7-4 TDM Mode Protocol Timing (No Idle BCLK Cycles, PASI_TX_OFFSET = 2)**

![TAC5112 TDM Mode Protocol Timing (PASI_TX_OFFSET = 0 and PASI_BCLK_POL = 1)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-NLD7-NH12-QQ9XPBB5N493-low.svg) 
...
![TAC5112 I2S Mode Standard Protocol Timing (PASI_TX_OFFSET = 0)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-50KZ-R16C-E3SJI95LN0DN-low.svg) 

**Figure 7-6 I<sup>2</sup>S Mode Standard Protocol Timing (PASI_TX_OFFSET = 0)**

![TAC5112 I2S Protocol Timing (PASI_TX_OFFSET = 1)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-B2UV-CQRK-NP9DPTI258BB-low.svg) 

**Figure 7-7 I<sup>2</sup>S Protocol Timing (PASI_TX_OFFSET = 1)**

![TAC5112 I2S Protocol Timing (No Idle BCLK Cycles, PASI_TX_OFFSET = 0)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-G0V4-DCE6-6Q05T7ACC1VJ-low.svg) 

**Figure 7-8 I<sup>2</sup>S Protocol Timing (No Idle BCLK Cycles, PASI_TX_OFFSET = 0)**

![TAC5112 I2S Protocol Timing (PASI_TX_OFFSET = 0 and PASI_BCLK_POL = 1)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-E2GP-NT58-057NHH5GDZ7K-low.svg) 
...
![TAC5112 LJ Mode Standard Protocol Timing (TX_OFFSET = 0)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-LCMR-R6I5-M1FY08KIJRXO-low.svg) 

**Figure 7-10 LJ Mode Standard Protocol Timing (TX_OFFSET = 0)**

![TAC5112 LJ Protocol Timing (TX_OFFSET = 2)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-MZDP-K3SF-1HS50K3DSTAV-low.svg) 

**Figure 7-11 LJ Protocol Timing (TX_OFFSET = 2)**

![TAC5112 LJ Protocol Timing (No Idle BCLK Cycles, TX_OFFSET = 0)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-MAR1-RTQP-ZI06W1UYWL5T-low.svg) 

**Figure 7-12 LJ Protocol Timing (No Idle BCLK Cycles, TX_OFFSET = 0)**

![TAC5112 LJ Protocol Timing (TX_OFFSET = 1 and BCLK_POL = 1)](https://www.ti.com/ods/images/SLASF24A/GUID-20241114-SS0I-NAM9-RIJQ-6CETED82ALPB-low.svg) 
...
The device has many supported features and flexible options that can be used in the system to seamlessly connect multiple TAC5112 devices by sharing a single common I<sup>2</sup>C or SPI control bus and an audio serial interface bus. This architecture enables multiple applications to be applied to a system that require a microphone or speaker array for beam-forming operation, audio conferencing, noise cancellation, and so forth. [Figure 7-14](#SLAS892BUS) shows a diagram of multiple TAC5112 devices in a configuration where the control and audio data buses are shared.

![TAC5112 Multiple TAC5112 Devices With Shared Control and Audio Data Buses](https://www.ti.com/ods/images/SLASF24A/GUID-20221226-SS0I-JMKD-SRPX-1QZVF9BNJTWJ-low.svg) 

**Figure 7-14 Multiple TAC5112 Devices With Shared Control and Audio Data Buses**
...
-   I<sup>2</sup>C broadcast simultaneously writes to (or triggers) all TAC5112 devices
...
The TAC5112 consists of two pairs of analog input pins (INxP and INxM) that can be configured as differential inputs or single-ended inputs for the recording channel. The device supports simultaneous recording of up to two analog channels using the high-performance multichannel ADC. The input source for the analog pins can be from electret condenser analog microphones, microelectrical-mechanical system (MEMS) analog microphones, or line-in (auxiliary) inputs from the system board. Analog inputs support differential input, single-ended inputs (two pin and one-pin) with AC and DC coupling options. [Table 7-13](#SBAS892INSRC) shows the input source selection for the record channel 1.
...
![TAC5112 Differential AC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b00 and ADC_CHx_CM_TOL set to 2'b00 or 2'b01 or 2'10)](https://www.ti.com/ods/images/SLASF24A/GUID-20241120-SS0I-Y8JI-4R8W-9M4ZTFB2E8CU-low.svg)
...
![TAC5112 Single-ended AC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b01 and ADC_CHx_CM_TOL set to 2'b00 or 2'b01 or 2'10)](https://www.ti.com/ods/images/SLASF24A/GUID-20231210-SS0I-5CDQ-D09W-FP7XHH0FZMB2-low.svg)
...
![TAC5112 Single-ended mux on INxP AC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b10 and ADC_CHx_CM_TOL set to 2'b00 or 2'b01 or 2'10)](https://www.ti.com/ods/images/SLASF24A/GUID-20241202-SS0I-6A74-62ON-N23YJHQ2F062-low.svg)
...
![TAC5112 Differential DC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b00 and ADC_CHx_CM_TOL set to 2'b01 or 2'10)](https://www.ti.com/ods/images/SLASF24A/GUID-20241120-SS0I-2E5I-2H7D-RBQJ83RA34AZ-low.svg)

**Figure 7-16 Differential DC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b00 and ADC_CHx_CM_TOL set to 2'b01 or 2'10)**

![TAC5112 Single-ended DC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b01 and ADC_CHx_CM_TOL set to 2'b01 or 2'10)](https://www.ti.com/ods/images/SLASF24A/GUID-20231210-SS0I-LQSR-R4FK-J4FPC18M6Q9N-low.svg)

**Figure 7-18 Single-ended DC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b01 and ADC_CHx_CM_TOL set to 2'b01 or 2'10)**

![TAC5112 Single-ended mux on INxP DC-Coupled Input Connection (ADC_CHx_INSRC set to 2'b10 and ADC_CHx_CM_TOL set to 2'b01 or 2'10)](https://www.ti.com/ods/images/SLASF24A/GUID-20241120-SS0I-SNWD-IXCN-02NUS9AIWHF0-low.svg)
...
The TAC5112 also supports an incremental mode of ADC where analog input channels can be used for DC measurements. This can be configured by setting IADC_EN (P0_R81_D\[7\]). For more details on the incremental mode of ADC, refer [Section 7.3.8](GUID-3BC6ABC6-84B3-49D7-9269-FAF14A8553BA.html).
...
The TAC5112 supports up to 2\-channel differential output, up to 2\-channel pseudo-differential output, and up to 4\-channel single-ended output. Each of the output channels can be independently configured for differential or single-ended output.
...
![TAC5112 Differential Output Connection (OUT1x_CFG[2:0] = 3'b000)](https://www.ti.com/ods/images/SLASF24A/GUID-20250103-SS0I-H2CV-1OAH-929U7RIV0XS1-low.svg)

**Figure 7-21 Differential Output Connection (OUT1x_CFG\[2:0\] = 3'b000)**

![TAC5112 Psuedo-differential Output Connection with External Common-Mode Sense (OUT1x_CFG[2:0] = 3'b101)](https://www.ti.com/ods/images/SLASF24A/GUID-20250103-SS0I-8Z2W-Q8OJ-H1KKTZK25IVH-low.svg)

**Figure 7-23 Psuedo-differential Output Connection with External Common-Mode Sense (OUT1x_CFG\[2:0\] = 3'b101)**

![TAC5112 Mono Single-ended Output Connection on OUT1P (OUT1x_CFG[2:0] = 3'b010)](https://www.ti.com/ods/images/SLASF24A/GUID-20250103-SS0I-SXKA-Y5MS-IFEQA65QB8G0-low.svg)

**Figure 7-22 Mono Single-ended Output Connection on OUT1P (OUT1x_CFG\[2:0\] = 3'b010)**

![TAC5112 Stereo Single-ended Output Connection (OUT1x_CFG[2:0] = 3'b001)](https://www.ti.com/ods/images/SLASF24A/GUID-20250103-SS0I-WIAF-0NS9-D3KNO3YUH73D-low.svg)

**Figure 7-24 Stereo Single-ended Output Connection (OUT1x_CFG\[2:0\] = 3'b001)**

The TAC5112 can support a variety of loads including headphone, lineout, and receiver amplifiers. Load drive configurations are available for each pin independently. OUT1P_DRIVE\[1:0\] (P0_R101_D\[7:6\]) configures the load drive capability for the OUT1P pin. Similary, OUT1M_DRIVE\[1:0\], OUT2P_DRIVE\[1:0\], OUT2M_DRIVE\[1:0\] control the output drive for OUT1M, OUT2P and OUT2M respectively.
...
![TAC5112 Digital PDM Microphones Connection Diagram for the TAC5112](https://www.ti.com/ods/images/SLASF24A/GUID-20250103-SS0I-4UKI-N50G-FKIJME48HQZM-low.svg) 

**Figure 7-25 Digital PDM Microphones Connection Diagram for the TAC5112**
...
![TAC5112 Digital PDM Microphone Protocol Timing Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-DD505051-8067-425E-9213-BA287C83AD40-low.gif) 
...
![TAC5112 HPF Filter Frequency Response Plot](https://www.ti.com/ods/images/SLASF24A/GUID-3DA4891F-9467-4644-921B-98474D40A913-low.gif)
...
Equation 1. ![TAC5112](https://www.ti.com/ods/images/SLASF24A/GUID-467C00D0-DF25-47F8-AFD0-8FA0B6BCEFC3-low.gif)
...
![TAC5112 Programmable Digital Mixer Block Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-014EBA2A-1F30-4F74-9A49-A68A00CB9BB2-low.gif)
...
![TAC5112 AGC Characteristics](https://www.ti.com/ods/images/SLASF24A/GUID-278960F3-B360-429D-850A-F843519C446D-low.gif) 

**Figure 7-68 AGC Characteristics**

The target level (AGC_LVL) represents the nominal approximate output level at which the AGC attempts to hold the ADC output signal level. The TAC5112 allows programming of different target levels. The target level is recommended to be set with enough margin to prevent clipping when loud sounds occur. For further details on the AGC various configurable parameter and application use, see [_Using the Automatic Gain Controller (AGC) in TAx5x1x Family_ application report](https://www.ti.com/lit/pdf/SBAA401). TI recommends using the PPC3 GUI for configuring the programmable coefficients settings; for more details see the [_TAC5212EVM-PDK Evaluation module_ user's guide](https://www.ti.com/lit/pdf/SBAU359) and the [PurePath™ console graphical development suite](http://www.ti.com/tool/PUREPATHCONSOLE).


##### 7.3.9.1.10  Voice Activity Detection (VAD)

The TAC5112 supports voice activity detection (VAD) mode as part of low power activity detection (LPAD) schemes. In this mode, the TAC5112 continuously monitors one of the input channels for voice detection. The device consumes low quiescent current from the AVDD supply in this mode. This feature can be enabled by setting VAD_EN (P0_R120_D\[2\]) to 1'b1. On detecting voice activity, the TAC5112 can alert the host through an interrupt or auto wake up and start recording based on the I<sup>2</sup>C programmed configuration. This alert can be configured through the LPAD_MODE (P1_R30_D\[7:6\]) register bits.
...
The TAC5112 supports ultrasonic activity detection (UAD) mode as part of low power activity detection (LPAD) schemes. In this mode, the TAC5112 continuously monitors one of the input channels for signals in the ultrasonic frequency band. The device consumes low quiescent current from the AVDD supply in this mode. This feature can be enabled by setting UAD_EN (P0_R120_D\[3\]) to 1'b1. On detecting ultrasonic activity, the TAC5112 can alert the host through an interrupt or auto wake up and start recording based on the I<sup>2</sup>C programmed configuration. This alert can be configured through the LPAD_MODE (P1_R30_D\[7:6\]) register bits.
...
![TAC5112 DAC Signal-Chain Processing Flowchart](https://www.ti.com/ods/images/SLASF24A/GUID-20230612-SS0I-BXC2-DWST-QKNKCNPNDLTK-low.svg) 

**Figure 7-69 DAC Signal-Chain Processing Flowchart**

The DAC signal chain offers a highly flexible low-noise playback path for low-noise and high-fidelity audio applications. This low-noise and low-distortion, multibit, delta-sigma DAC enables the TAC5112 to achieve 114dB dynamic range in very low power. Moreover, the DAC architecture has inherent antialias filtering with a high rejection of out-of-band frequency noise around multiple modulator frequency components. Therefore, the device prevents noise from aliasing into the audio band. Further on in the signal chain, an integrated, high-performance multistage digital interpolation filter sharply cuts off any out-of-band frequency noise with high stop-band attenuation.
...
Equation 3. ![TAC5112](https://www.ti.com/ods/images/SLASF24A/GUID-467C00D0-DF25-47F8-AFD0-8FA0B6BCEFC3-low.gif)
...
![TAC5112 Typical I2C Sequence](https://www.ti.com/ods/images/SLASF24A/GUID-20241204-SS0I-NC5N-09B1-F7SMVZWBV150-low.svg) 
...
![TAC5112 I2C Single-Byte Write Transfer](https://www.ti.com/ods/images/SLASF24A/GUID-5EA2924A-8202-4775-9122-BD516F77FDE0-low.gif) 
...
![TAC5112 I2C Multiple-Byte Write Transfer](https://www.ti.com/ods/images/SLASF24A/GUID-0DF569B2-E3CB-45C6-A6E1-A944BC13AE62-low.gif) 
...
![TAC5112 I2C Single-Byte Read Transfer](https://www.ti.com/ods/images/SLASF24A/GUID-FD450CD0-5259-4445-A68A-E3052B742DC3-low.gif) 
...
![TAC5112 I2C Multiple-Byte Read Transfer](https://www.ti.com/ods/images/SLASF24A/GUID-2129A508-5C4A-49BA-B0EB-C39BA9967AEE-low.gif) 
...
The general SPI protocol allows full-duplex, synchronous, serial communication between a host processor (the controller) and peripheral devices. The SPI controller (in this case, the host processor) generates the synchronizing clock (driven on to SCLK) and initiates transmissions by taking the peripheral-select pin CSZ from high to low. The SPI peripheral devices (such as the TAC5112) depend on a controller device to start and synchronize transmissions. A transmission begins when initiated by an SPI controller. The byte from the SPI controller begins shifting in on the peripheral PICO pin under the control of the controller serial clock (driven onto SCLK). When the byte shifts in on the PICO pin, a byte shifts out on the POCI pin to the controller shift register.
...
![TAC5112 SPI Single-Byte Write Transfer](https://www.ti.com/ods/images/SLASF24A/GUID-20241127-SS0I-4PMZ-8R9P-BOVE7ZOJPL3N-low.svg) 

**Figure 7-114 SPI Single-Byte Write Transfer**

![TAC5112 SPI Single-Byte Read Transfer](https://www.ti.com/ods/images/SLASF24A/GUID-20241127-SS0I-GPAH-L987-1H1D17ROWBMU-low.svg) 
...
| AVDD supply current consumption | 27.6 mA, with AVDD = 3.3V (MICBIAS on, PLL on, stereo recording and playback, f<sub>s</sub> = 48kHz) |
...
![TAC5112 ADC FFT with -60dBFS Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241227-SS0I-AW60-Q7M0-OJXVOWZKGZNQ-low.svg)
...
![TAC5112 DAC FFT with -60dBFS Input](https://www.ti.com/ods/images/SLASF24A/GUID-20250102-SS0I-BFB2-F420-AB4ZSJQK8R1H-low.svg)
...
![TAC5112 ADC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20241227-SS0I-C9F9-ABFE-SL7LFLDILGWN-low.svg)
...
![TAC5112 DAC THD+N Level vs Input](https://www.ti.com/ods/images/SLASF24A/GUID-20250102-SS0I-HDRZ-SXZP-CG4U4DT1ZVEV-low.svg)
...
![TAC5112 Power-Supply Sequencing Requirement Timing Diagram](https://www.ti.com/ods/images/SLASF24A/GUID-20241126-SS0I-EL9W-DS8V-UYRWXKNK06KH-low.svg) 
...
![TAC5112 Example Layout](https://www.ti.com/ods/images/SLASF24A/GUID-20250101-SS0I-0Q0T-NX1Y-I0K6ILPLQH7Z-low.svg) 
